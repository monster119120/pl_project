...
__all__ = ['ResNet', 'resnet50', 'resnet101', 'resnet152', 'resnet50_dynamic', 'resnet101_dynamic', 'resnet152_dynamic']

model_urls = {
    'resnet18': 'https://download.pytorch.org/models/resnet18-5c106cde.pth',
    'resnet34': 'https://download.pytorch.org/models/resnet34-333f7ec4.pth',
    'resnet50': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',    # v2.0的参数
    # 'resnet50': "https://download.pytorch.org/models/resnet50-0676ba61.pth",  # IMAGENET1K_V1
    # 'resnet50': "https://download.pytorch.org/models/resnet50-0676ba61.pth",  # IMAGENET1K_V2
...
def resnet50_dynamic(pretrained=False, **kwargs):
    model = ResNet(BottleneckDynamic, [3, 4, 6, 3], **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50']), strict=False)
    return model


def resnet101_dynamic(pretrained=False, **kwargs):
    model = ResNet(BottleneckDynamic, [3, 4, 23, 3], **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet101']))
    return model


def resnet152_dynamic(pretrained=False, **kwargs):
    model = ResNet(BottleneckDynamic, [3, 8, 36, 3], **kwargs)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet152']))
    return model

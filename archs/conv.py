...
#         self.kernel_templates['expert1'] = nn.Conv2d(in_channels, out_channels,
#                                                      kernel_size=kernel_size,
#                                                      stride=stride,
#                                                      padding=padding,
#                                                      groups=min(in_channels, out_channels),
#                                                      bias=bias)
#         self.kernel_templates['expert2'] = nn.Conv2d(in_channels, out_channels,
#                                                      kernel_size=1,
#                                                      stride=stride,
#                                                      padding=0,
#                                                      bias=bias)
#         self.kernel_templates['expert3'] = nn.Conv2d(in_channels, out_channels,
#                                                      kernel_size=(kernel_size, 1),
#                                                      stride=stride,
#                                                      padding=(padding, 0),
#                                                      bias=bias)
#         self.kernel_templates['expert4'] = nn.Conv2d(in_channels, out_channels,
...
class Conv2dDynamic(nn.Conv2d):
    def __init__(self, in_channels: int,
                 ...
                 squeeze: int = None,
                 attention_in_channels: int = None) -> None:
        super(Conv2dDynamic, self).__init__(in_channels, out_channels, kernel_size=kernel_size, stride=stride, padding=padding, bias=bias)
